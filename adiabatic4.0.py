...
def make_combined_plots(combined_df, partner, E_collision_cm1, output_dir):
    ...
    print(f"\nSaved plot: {rho_plot_file}")
    print(f"Saved plot: {xi_plot_file}")
    print(f"Saved plot: {transition_plot_file}")
...
def main():
    ...
    # Output directory
    output_dir = f"rho_xi_transition_{partner}_E{E_collision_cm1:.0f}_all_r"
